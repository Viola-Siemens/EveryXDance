...
public class SheepFurModelMixin<T extends Sheep> extends QuadrupedModel<T> implements IPrepareDanceModel {
	protected SheepFurModelMixin(ModelPart root, boolean scaleHead, float babyYHeadOffset, float babyZHeadOffset, float babyHeadScale, float babyBodyScale, int bodyYOffset) {
